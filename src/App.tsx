...
function App() {
  ...
  const [folder, setFolder] = useState<string>("some");
  ...
  return (
    <div className="container">
      ...
      <div className="main">
        <div id="editor"></div>
        <div className="column-3" style={{ paddingLeft: "1em" }}>
          <p>{folder}</p>
          <pre>{res}</pre>
        </div>
      </div>
